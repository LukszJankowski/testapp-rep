package io.projectone.application.repository;

import io.projectone.application.TestappApp;
import io.projectone.application.config.Constants;
import io.projectone.application.config.audit.AuditEventConverter;
import io.projectone.application.domain.PersistentAuditEvent;
...
import static io.projectone.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
